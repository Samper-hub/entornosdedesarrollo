...
class CalculadoraSamiAdakoujTest2 {
    private CalculadoraSamiAdakouj calc;
    @BeforeEach
    void setUp() {
        calc = new CalculadoraSamiAdakouj (20, 10);
    ...
    void testSumaConParametros(int valor) {
        CalculadoraSamiAdakouj calc = new CalculadoraSamiAdakouj (valor, 10);
    ...
    void testSumaConVariosValores(int a, int b, int resultadoEsperado) {
        CalculadoraSamiAdakouj calc = new CalculadoraSamiAdakouj(a, b);
