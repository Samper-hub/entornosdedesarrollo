...
class CalculadoraSamiAdakoujTest {
    ...
    void suma() {
        ...
        CalculadoraSamiAdakouj calc = new CalculadoraSamiAdakouj(20, 10);
    ...
    public void testDivCero() {
        try {
            CalculadoraSamiAdakouj calc = new CalculadoraSamiAdakouj (20, 0);
    ...
    @Test
    void testResta2() {
        CalculadoraSamiAdakouj calc = new CalculadoraSamiAdakouj(10, 20);
        int valorEsperado = 10;
